      ...
      <div class="modalcontianer">
        <b-form>
          ...
          >
            ...
            <b-form-checkbox value="data" v-model="form.checkedtype">Algorithm</b-form-checkbox>
            <b-form-checkbox value="cad" v-model="form.checkedtype">AutoCad</b-form-checkbox>
          </b-form-group>
